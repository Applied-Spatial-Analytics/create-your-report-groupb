...
After deriving the land surface temperature for Rotterdam, the results showcased in the figure below are clearly defined. Lighter areas correspond to larger green areas and the water bodies in the city extent. In contrast, the darker areas correspond to places such as industrial zones and inner ports of Rotterdam, which are the biggest contributor of extreme LST values on the map: ![Land surface temperature of Rotterdam in July 2025](maps/lst_rotterdam.png){#fig-lst-rdm fig-align="center"}
