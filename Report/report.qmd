...
- Rotterdam: neighborhood data from CBS (<https://www.cbs.nl/nl-nl/cijfers/detail/86165NED>) - including most spatial justice metrics, Leefbaarometer 2024 (<https://www.leefbaarometer.nl/page/Opendata>), buildings from the BAG (including function) using the PDOK plugin in QGIS, road network and green areas from OSM (using QuickOSM plugin in QGIS)
...
![Spatial Justice Index per sub-district in Guangzhou](maps/SJI_Guangzhou.png){#fig-sji-guangzhou fig-pos="H" fig-align="center"}

## Relationship Urban Climate and Spatial Justice

![Spatial Justice Index and Land Surface Temperature in Guangzhou](maps/LST_SJI_Guangzhou.png){#fig-sji-lst-gz fig-pos="H" fig-align="center"}
