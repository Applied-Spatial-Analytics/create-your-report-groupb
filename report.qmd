...
For both Rotterdam and Guangzhou, the analysis relies on a combination of spatial and socio-economic datasets. For Rotterdam, data was primarily sourced from the *Leefbaarometer 2024* and *CBS Buurtgegevens*, which provide comprehensive neighborhood-level information on physical liveability, social cohesion, housing conditions, and demographic characteristics. These datasets are complemented by high-resolution Land Surface Temperature (LST) data derived from satellite imagery, enabling precise mapping of urban heat distribution. 
...
![Spatial Justice Index per neighborhood in Rotterdam comparable to Guangzhou](Maps_for_report/RotterdamSJI.png){#fig-sji-rot-full fig-pos="H" fig-align="center" width="80%"}
