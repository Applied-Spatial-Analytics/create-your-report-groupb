...
![Distance to green vs LST in Rotterdam](results_lst_distance_to_green/rotterdam_dist_lst.png){#fig-rot-green-lst fig-pos="H" fig-align="center" width="70%"}
...
![Spatial Justice Index per neighbourhood in Rotterdam comparable to Guangzhou](Maps_for_report/RotterdamSJI.png){#fig-sji-rot-simple fig-pos="H" fig-align="center" width="80%"}
...
![Distance to green vs LST in Guangzhou](results_lst_distance_to_green/guangzhou_dist_lst.png){#fig-green-lst-guangzhou fig-pos="H" fig-align="center" width="70%"}
