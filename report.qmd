...
<!-- I think the UMEP plugin is too much work to fix. It needs a lot of datasets (at least DTM and DSM -  which I can easily find in QGIS but I need them on my laptop - and downloading them is like 60gb for just the rotterdam area) and takes a lot of time. -->
...
These central districts are divided into subdistricts, for which there is data available on population density and mean land surface temperature.
...
![Distance to green vs LST in Guangzhou](results_lst_distance_to_green/guangzhou_dist_lst.png){#fig-plot width="70%" fig-pos="H"}
